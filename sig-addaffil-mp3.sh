...
#	/bin/ng-chown 0 0 0 1 0 1 XXXXX XXXXX "$pre_path/$1"
   ...
   echo "Syntax: SITE ADDAFFILMP3 <group> [pre_dir_path]"
fi

#echo "Updating dirscript with -> ADD $1 MP3, currentlu in $PWD"
exec "mr-affil_dirscript.sh" ADD $1 MP3
