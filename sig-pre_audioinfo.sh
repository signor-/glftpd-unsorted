...
function do_audio_info () {
	for found_dir in $complete_dir; do
		...
		do
			...
			echo ". -  -  --  ---   --- -------------------------- ---   ---  --  -  - ." > "$audioinfo"
			echo "|                       _____   ______ _______                       |" >> "$audioinfo"
			echo "|                      |_____] |_____/ |______                       |" >> "$audioinfo"
			echo "|                      |       |    \_ |______                       |" >> "$audioinfo"
			echo "|       ______ _______        _______ _______ _______ _______        |" >> "$audioinfo"
			echo "|      |_____/ |______ |      |______ |_____| |______ |______        |" >> "$audioinfo"
			echo "|      |    \_ |______ |_____ |______ |     | ______| |______        |" >> "$audioinfo"
			echo "|                                                                    |" >> "$audioinfo"
			echo "| -  -  --  ---   --- -------------------------- ---   ---  --  -  - |" >> "$audioinfo"
			echo "|                                                                    |" >> "$audioinfo"
			echo "|     T H I S    W A S    A    S I T E    P R E    R E L E A S E     |" >> "$audioinfo"
			echo "|                                                                    |" >> "$audioinfo"
