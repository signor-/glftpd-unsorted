...
function do_musicvideo_info () {
	for found_dir in $complete_dir; do
		...
		do
			...
			echo "[+] created -> .musicvideoinfo"
			
			echo ".--------------------------------------------------------------------." > "$musicvideoinfo"
			echo "|                _    _ _____ ______  _______  _____                 |" >> "$musicvideoinfo"
  			echo "|                 \  /    |   |     \ |______ |     |                |" >> "$musicvideoinfo"
   			echo "|                  \/   __|__ |_____/ |______ |_____|                |" >> "$musicvideoinfo"
			echo "|                     _____ __   _ _______  _____                    |" >> "$musicvideoinfo"
			echo "|                       |   | \  | |______ |     |                   |" >> "$musicvideoinfo"
			echo "|                     __|__ |  \_| |       |_____|                   |" >> "$musicvideoinfo"
			echo "|                                                                    |" >> "$musicvideoinfo"
...
do_musicvideo_info "/glftpd/site/ARCHIVE/MVID"
